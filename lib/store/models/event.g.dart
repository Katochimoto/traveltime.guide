...
int _eventEstimateSize(
  ...
  bytesCount += 3 + object.rrule.length * 3;
...
void _eventSerialize(
  ...
  writer.writeStringList(offsets[9], object.points);
...
Event _eventDeserialize(
  ...
  final object = Event(
    ...
    locale: _EventlocaleValueEnumMap[reader.readByteOrNull(offsets[7])] ??
        AppLocale.en,
    logoImg: reader.readStringOrNull(offsets[8]),
    points: reader.readStringList(offsets[9]),
    publishedAt: reader.readDateTime(offsets[10]),
    rrule: reader.readString(offsets[11]),
